...
internal class ExpensesRepository(CashflowDbContext _dbContext) : IExpensesReadOnlyRepository, IExpensesWriteOnlyRepository, IExpensesUpdateOnlyRepository
{
